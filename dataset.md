# Appendix B: GRE Dataset

Please note that this repository does not contain, host, or redistribute the original GRE essay texts, prompt descriptions, or any proprietary materials. Educational Testing Services (ETS) holds the formal copyright of the GRE material and has not approved the publication of a standalone dataset.

To strictly comply with copyright protections and ensure all research falls under Fair Use guidelines, this repository provides only the following:

- Collation Instructions: Step-by-step guidance and public URLs to independently source the publicly available exam preparation essays directly from ETS
- Enhanced Annotations: Our independently generated trait-based sub-rubric scores (1-6) and supplementary evaluative feedback.

Users must independently download the original essays using the provided public resources to reconstruct the complete dataset for their own research.

## Table B1: GRE Essay Dataset Sources

| Name | Published | # Essays |
|------|-----------|----------|
| An Introduction to the Analytical Writing Section of the GRE General Test | 2003 | 12 |
